...
The home screen stacks those amounts, each with the dates it covers (for example, Sep 19 – Oct 2). Tap any one to see the bills, housing, and card remainders that add up to it. Tap a row to mark that bill or housing payment paid, or to record a payment on that card. Bills, credit cards, housing, pay, and settings live in the menu at the top right.
