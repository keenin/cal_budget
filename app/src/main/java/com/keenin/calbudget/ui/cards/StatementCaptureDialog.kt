    ...
    Dialog(
        ...
        Surface(
            ...
            Column(Modifier.padding(24.dp)) {
                ...
                Text(
                    "Enter the statement balance. Use 0 if nothing is owed. It counts toward Until payday, Next period, or Following period, depending on when it is due. A partial payment can be recorded later on the card.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                )
